...
import view.manager.student.fee;
/**
 *
 * @author luan
 */
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        muMark.setText("Mark");
        muMark.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                muMarkActionPerformed(evt);
            }
        });
        ...
        muFee.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/20x20/fee.png"))); // NOI18N
        muFee.setText("Fee");
        muFee.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void muFeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_muFeeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_muFeeActionPerformed

    private void muMarkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_muMarkActionPerformed
        // TODO add your handling code here:
    ...
    private javax.swing.JMenu muFee;
